...
.summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-bottom:14px}.metric{border:1px solid var(--line);background:rgba(17,21,29,.78);padding:15px;border-radius:14px}.metric span{display:block;color:var(--faint);font-size:12px}.metric b{display:block;margin-top:6px;font-size:22px;font-variant-numeric:tabular-nums;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
...
.list{display:grid;grid-template-columns:repeat(auto-fill,minmax(360px,1fr));gap:12px;align-items:start}.card{border:1px solid var(--line);background:rgba(17,21,29,.82);border-radius:14px;padding:15px;display:grid;gap:14px;min-height:148px}.card:hover{border-color:#3c465a}.card-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.card h3{margin:0;font-size:15px;letter-spacing:-.01em;line-height:1.25}.comment{margin-top:5px;color:var(--muted);font-size:12px;line-height:1.45}.status-pill{border:1px solid rgba(133,225,180,.34);background:rgba(133,225,180,.06);color:var(--success);font-size:11px;border-radius:999px;padding:4px 7px;white-space:nowrap}.fields{display:flex;flex-wrap:wrap;gap:7px}.field{border:1px solid var(--line);background:rgba(255,255,255,.022);color:#c9d2df;border-radius:9px;padding:6px 8px;font-size:12px;font-variant-numeric:tabular-nums}.actions{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end;margin-top:auto}.empty{grid-column:1/-1;border:1px dashed var(--line-strong);border-radius:14px;padding:34px;text-align:center;color:var(--muted);background:rgba(17,21,29,.42)}
